...
<script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.0.0/flowbite.min.js"></script>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-center">
        <h1 class="text-9xl font-bold text-red-500">419</h1>
        <p class="text-xl text-gray-700 mt-2">¡Oops! Has intentado hacer demasiadas solicitudes.</p>

        <!-- GIF aleatorio de Giphy -->
        <img id="gif" class="w-80 h-80 rounded-lg shadow-lg mt-5" alt="Demasiadas solicitudes">
